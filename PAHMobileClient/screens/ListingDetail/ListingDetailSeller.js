...
function ListingDetailSeller(props) {
  ...
  function deleteProduct() {
    ...
    ProductRepository.deleteProduct(axiosContext, product_id)
      .then(response => {
        goBack()
      })
      .catch(error => {
                  ...
                  product.feedbacks.length ? (
                    <View>
                      ...
                      <TouchableOpacity
                        style={styles.secondaryButton}
                        onPress={() =>
                          navigate('ListingFeedback', {product_id: product.id})
                        }>
      ...
      <Modal
        ...
        <View
          ...
          <View style={styles.modalContainer}>
            ...
            />
            <Text style={styles.modalTitle}>Bạn có chắc?</Text>
            <Text style={styles.modalText}>Sau khi xóa sản phẩm sẽ không thể khôi phục!</Text>
            {/* Delete Confirmation */}
            <View
              ...
              style={[styles.deleteButtonStyle,{borderWidth:1,borderColor:colors.primary}]}>
                <Text style={[styles.deleteButtonText,{color:colors.primary}]}>Hủy</Text>
              </TouchableOpacity>
              <TouchableOpacity
              onPress={deleteProduct} 
              style={[styles.deleteButtonStyle,{backgroundColor:'red'}]}>
                <Text style={[styles.deleteButtonText,{color:'white'}]}>Xóa</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
